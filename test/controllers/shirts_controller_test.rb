...
class ShirtsControllerTest < ActionController::TestCase
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post :create, shirt: { description: @shirt.description, path: @shirt.path, shape_id: @shirt.shape_id }
    end
  ...
  test "should update shirt" do
    patch :update, id: @shirt, shirt: { description: @shirt.description, path: @shirt.path, shape_id: @shirt.shape_id }
    assert_redirected_to shirt_path(assigns(:shirt))
  end
